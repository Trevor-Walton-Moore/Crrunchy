...
Revision ID: 493f5ffc09b5
Revises:
Create Date: 2023-01-25 15:11:47.321961
...
def upgrade():
    ...
    sa.Column('adoption_day', sa.String(), nullable=True),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE users_products SET SCHEMA {SCHEMA};")
